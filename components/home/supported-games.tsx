...
function SupportedGames() {
  return (
      <div className="flex flex-col h-screen">
        ...
        <svg className={styles.arrowSVG} width="560" height="100" xmlns="http://www.w3.org/2000/svg">
          <rect id="svg_3" height="0.33333" width="550" y="20" x="0" stroke="#904E55" fill="#904E55"/>
          <ellipse ry="5" rx="5" id="svg_4" cy="20" cx="555" stroke="#904E55" fill="#904E55"/>
        </svg>
